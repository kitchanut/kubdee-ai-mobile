...
export const MOBILE_CHANGELOG: MobileChangelogRelease[] = [
  {
    ...
    changes: [
      {
        type: 'fixed',
        text: 'เมื่อวิดีโอถูกลบ ย้าย หรือสิทธิ์ไฟล์หมดอายุ ระบบจะแจ้งสาเหตุเป็นภาษาไทยแทนข้อความผิดพลาดทางเทคนิค'
      },
      {
        type: 'fixed',
        text: 'การโพสต์ผ่าน Buffer จะหยุดคิวและแจ้งเวลารอเมื่ออัปโหลดถี่เกินกำหนด แทนการลองคลิปถัดไปซ้ำจนล้มเหลวทั้งหมด'
      },
      {
        type: 'improved',
        text: 'ลดการอัปโหลดวิดีโอเดิมซ้ำเมื่อโพสต์ใหม่หรือโพสต์หลายแพลตฟอร์ม ช่วยให้ทำงานเร็วขึ้นและใช้ดาต้าน้อยลง'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'improved',
        text: 'อัปเดตเวอร์ชัน Shopee ที่ผ่านการทดสอบของระบบดึงสินค้าเป็น 3.79.27 เพื่อให้ตรวจสอบความเข้ากันได้กับมือถือได้ตรงรุ่น'
      },
      {
        type: 'improved',
  ...
  },
  {
    version: '0.9.19',
    date: '2026-08-04',
    highlight: 'แก้ปัญหาจากรายงานผู้ใช้ — ปิดแผงแชร์ Shopee ไม่ได้บางเครื่อง และโพสต์ล้มเหลวบน Shopee เวอร์ชันใหม่',
    changes: [
      {
        type: 'fixed',
        text: 'บางเครื่องปุ่มกากบาทของแผงแชร์ Shopee ไม่มีป้ายกำกับให้ระบบจับ ทำให้ปิดแผงเองไม่ได้ — เพิ่มการค้นหาปุ่มจากตำแหน่งบนแผงแทน'
      },
      {
        type: 'fixed',
        text: 'Shopee เวอร์ชันใหม่เปิดหน้าบัญชี Shopee Video ให้ทันทีโดยไม่ต้องกดเมนู แต่ระบบเดิมยังหาเมนูแล้วตัดสินว่าล้มเหลว — ตอนนี้ตรวจว่าถึงหน้าเป้าหมายแล้วไปต่อให้เอง'
      },
      {
        type: 'fixed',
        text: 'ตรวจสอบปุ่มสวิตช์ในหน้าโพสต์ล้มเหลวเพราะอ่านภาพหน้าจอถี่เกินไป — เพิ่มการรอและลองใหม่อัตโนมัติ'
      },
      {
        type: 'improved',
        text: 'ภาพตัวอย่างวิดีโอในคลังใช้หน่วยความจำน้อยลงประมาณ 10 เท่า และบันทึกไฟล์เล็กลง'
      }
    ]
  },
  {
    version: '0.9.18',
    date: '2026-08-03',
    highlight: 'ลดการใช้หน่วยความจำครั้งใหญ่ — เครื่อง RAM น้อยใช้งานลื่นขึ้นและแอปปิดตัวเองน้อยลง',
    changes: [
      {
        type: 'improved',
        text: 'ลดการใช้หน่วยความจำระหว่างรัน Auto Pilot ลงมาก — ไม่เก็บรูปที่สร้างเสร็จค้างไว้ในหน่วยความจำตลอดทั้งรอบ ช่วยให้รันยาวหลายสินค้าหลายรอบบนเครื่อง RAM น้อยได้โดยแอปไม่ปิดตัวเอง'
      },
      {
        type: 'improved',
        text: 'คลังรูป/วิดีโอโหลดเฉพาะรายการที่อยู่ใกล้จอ และย่อรูปตอนแสดงผลตามขนาดจริงที่เห็น — เปิดคลังขนาดใหญ่เร็วขึ้นและกินหน่วยความจำน้อยลงมาก'
      },
      {
        type: 'improved',
        text: 'บันทึก log ระหว่างโพสต์อัตโนมัติแบบเป็นชุดแทนทีละบรรทัด ลดอาการแอปค้างระหว่างโพสต์ต่อเนื่องหลายคลิป'
      },
      {
        type: 'fixed',
        text: 'แถบความคืบหน้าในหน้า Auto Pilot เคลื่อนไหวลื่นขึ้นและไม่กินทรัพยากรเครื่องต่อเนื่องระหว่างรัน'
      }
    ]
  },
  {
    version: '0.9.17',
    date: '2026-08-03',
    highlight: 'โหมดใหม่ "จากเว็บ" ในคลังวิดีโอ — ดูคลิปที่สร้างจากหน้า /auto บนเว็บ แล้วเก็บเข้าคลังหรือส่งโพสต์ได้ทันที',
    changes: [
      {
        type: 'feature',
        text: 'คลังวิดีโอเพิ่มโหมด "จากเว็บ" (ปุ่มลูกโลกข้างช่องค้นหา) แสดงคลิปที่สร้างจากหน้า /auto บน kubdee.ai แบบสด กดเล่นดูได้ทันทีโดยไม่ต้องดาวน์โหลดก่อน'
      },
      {
        type: 'feature',
        text: 'เก็บคลิปจากเว็บเข้าคลังในเครื่องพร้อมข้อมูลสินค้าครบ (ลิงก์สินค้า แคปชั่น แฮชแท็ก) และส่งเข้าคิวโพสต์ Shopee/TikTok ได้เลย — ระบบดาวน์โหลดไฟล์ให้อัตโนมัติ และข้ามคลิปที่เคยเก็บแล้ว'
      },
      {
        type: 'improved',
        text: 'ระบบตรวจลิงก์คลิปอัตโนมัติ คลิปที่ลิงก์หมดอายุหรือไฟล์ถูกลบแล้วจะถูกซ่อนให้ ไม่ต้องกดลองผิดลองถูกเอง (แตะ "แตะเพื่อแสดง" เพื่อดูรายการที่ซ่อน)'
      }
    ]
  },
  {
    version: '0.9.16',
    date: '2026-08-02',
    highlight: 'คลิปสินค้าเดียวกันเข้าคลังครบทุกตัว พร้อมกู้คลิปที่เคยหายกลับมาให้',
    changes: [
      {
        type: 'fixed',
        text: 'คลิปหลายตัวของสินค้าเดียวกัน ทั้งที่รับจาก Cloud Transfer และที่สร้างในแอป เข้าคลังวิดีโอครบทุกตัวแล้ว — เดิมระบบบันทึกทับกันจนเหลือแค่คลิปเดียว'
      },
      {
        type: 'fixed',
        text: 'คลิปที่เคยหายจากปัญหาข้างต้นจะถูกกู้กลับเข้าคลังอัตโนมัติเมื่อเปิดแอปครั้งแรกหลังอัปเดต ในชื่อ "คลิปกู้คืน" มองเห็นได้จากทุกโปรไฟล์ — คลิปกู้คืนไม่มีข้อมูลสินค้าเดิม ต้องผูกสินค้าใหม่ก่อนโพสต์'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'fixed',
        text: 'รองรับ Shopee เวอร์ชันใหม่ 3.79.24 ที่ย้ายทางเข้าโพสต์วิดีโอ — ระบบใช้เมนู Live & Video บนหน้า ฉัน เป็นเส้นทางหลัก และยังกลับไปใช้เส้นทางโปรแกรม Affiliate เดิมให้เองเมื่อเจอ Shopee เวอร์ชันเก่า'
      },
      {
        type: 'improved',
        text: 'โหมดออโต้ใช้ชุดคำสั่งสร้างภาพ/วิดีโอชุดกลางเดียวกับเว็บและเดสก์ท็อป — ผลงานที่ได้ออกแนวทางเดียวกันทุกแพลตฟอร์ม และอัปเดตชุดคำสั่งจากส่วนกลางได้โดยไม่ต้องรออัปเดตแอป'
      }
    ]
  },
  {
    version: '0.9.12',
    date: '2026-07-23',
    highlight: 'แนบสินค้าและดึงสินค้า Shopee แม่นขึ้น — เลิกเดาสินค้า กันชื่อเพี้ยนจากป้ายโปรโมชัน',
    changes: [
      {
        type: 'fixed',
        text: 'เลิกเดาแนบสินค้าด้วยการค้นหาชื่อเมื่อแนบด้วยลิงก์ไม่สำเร็จ — วิธีเดิมเสี่ยงได้สินค้าร้านอื่นที่ชื่อคล้ายกัน ตอนนี้ถ้าแนบด้วยลิงก์ไม่ได้จะข้ามการแนบพร้อมแจ้งเหตุผลใน log แทน'
      },
      {
        type: 'fixed',
        text: 'โหมดขับอัตโนมัติข้ามสินค้าที่ไม่มีลิงก์ Shopee ตั้งแต่ต้น แบบเดียวกับหน้าโพสต์ปกติ — ไม่เสียเวลาโพสต์คลิปที่แนบสินค้าไม่ได้อยู่แล้ว'
      },
      {
        type: 'fixed',
        text: 'ดึงสินค้ามุมมองผู้ซื้อไม่จับป้ายโปรโมชันบนการ์ด (เช่น "ราคาพิเศษในไลฟ์") มาเป็นชื่อสินค้าอีกต่อไป และชื่อสินค้าไม่ติดเลข 0 นำหน้าแล้ว'
      },
      {
        type: 'improved',
        text: 'งานดึงสินค้าและแปลงลิงก์ที่สะดุดกลางคันจะแจ้งผลกลับมาชัดเจนขึ้น ไม่ค้างเงียบจนต้องรอนาน'
      }
    ]
  },
  {
    version: '0.9.11',
    date: '2026-07-22',
    highlight: 'โพสต์ Shopee นิ่งขึ้น — แก้งานโพสต์ถูกตัดจบทั้งที่ยังโพสต์อยู่ และกันโพสต์คลิปเดิมซ้ำ',
    changes: [
      {
        type: 'fixed',
        text: 'แก้ปัญหาสินค้าที่มีหลายคลิปโพสต์ Shopee แล้วระบบรอไม่นานพอ ขึ้นว่าไม่สำเร็จทั้งที่กำลังโพสต์อยู่ แถมพาสินค้าถัดไปโพสต์ไม่ได้ตามไปด้วย ตอนนี้รอครบตามจำนวนคลิปจริง'
      },
      {
        type: 'fixed',
        text: 'กันการโพสต์คลิปเดิมซ้ำ กรณีระบบแจ้งว่าไม่สำเร็จแต่คลิปโพสต์สำเร็จในเวลาต่อมา — รอบถัดไปจะไม่หยิบคลิปเดิมมาโพสต์อีก'
      },
      {
        type: 'improved',
        text: 'งานโพสต์ Shopee ที่สะดุดกลางคันจะแจ้งผลกลับมาชัดเจนขึ้น ไม่ค้างเงียบจนต้องรอนานเหมือนเดิม โดยเฉพาะบนเครื่องสเปคต่ำ'
      }
    ]
  },
  {
    version: '0.9.10',
    date: '2026-07-19',
    highlight: 'แก้ปัญหาแอปเด้งออกไปข้างนอกตอนดึงสินค้า Shopee ผ่านแผงแชร์',
    changes: [
      {
        type: 'fixed',
        text: 'แก้ปัญหาบางเครื่องดึงสินค้า Shopee แล้วหลุดออกไปหน้าอื่นหรือออกนอกแอปกลางคัน ทำให้เสียรอบทั้งชุด — เกิดจากตอนปิดแผงแชร์ระบบใช้ปุ่มย้อนกลับ ซึ่งย้อนอะไรก็ได้ที่อยู่บนสุด ไม่ได้ปิดเฉพาะแผงแชร์ ตอนนี้ปิดด้วยปุ่มกากบาทเท่านั้น'
      },
      {
        type: 'changed',
        text: 'ถ้าระบบปิดแผงแชร์เองไม่ได้ จะแจ้งใน log ให้กดปิดเองบนหน้าจอ พร้อมย้ำทุก 5 วินาทีและนับถอยหลัง 30 วินาที กดปิดเมื่อไหร่ก็ทำงานต่อทันที ถ้าครบเวลาแล้วยังไม่มีใครกดจะหยุดงานให้ แทนที่จะเดากดจนหลุดหน้า'
      }
    ]
  },
  {
    version: '0.9.9',
    date: '2026-07-19',
    highlight: 'ปักตะกร้า TikTok ตรวจสถานะสินค้าสดทุกครั้ง — สินค้าที่ถูกปิดไปแล้วจะไม่ถูกโพสต์',
    changes: [
      {
        type: 'fixed',
        text: 'แก้ปัญหาคลิปถูกโพสต์ทั้งที่สินค้าในตะกร้าถูกปิดหรือระงับไปแล้ว — ตอนปักตะกร้าระบบจะอ่านสถานะสินค้าสดจากหน้าค้นหาของ TikTok ทุกครั้ง ไม่เชื่อสถานะเก่าที่บันทึกไว้ในคลังตอนดึงสินค้า ซึ่งไม่เคยอัปเดตตามความจริง'
      },
      {
        type: 'changed',
        text: 'สินค้าที่สถานะไม่ใช่ ดำเนินอยู่ หรืออ่านสถานะไม่ได้ = ข้ามคลิปนั้นทันทีโดยไม่โพสต์ แล้วเดินหน้าโพสต์คลิปถัดไปต่อ พร้อมบอกสาเหตุที่ข้ามไว้ใน log ให้ตรวจย้อนได้'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'fixed',
        text: 'บางเครื่องที่แถบเมนู Shopee เป็นไอคอนล้วนไม่มีข้อความ ระบบหาปุ่ม "ฉัน" ไม่เจอ ทำให้ดึงสินค้าค้างที่หน้าแรก — รองรับแล้ว'
      },
      {
        type: 'fixed',
        text: 'ดึงสินค้าถูกใจแล้วบางตัวถูกข้าม (แตะสินค้าแล้วหน้ารายละเอียดไม่เปิด) — ระบบแตะซ้ำให้อีกครั้งก่อนตัดสินข้าม'
      },
      {
        type: 'improved',
        text: 'มุมมองพาร์ทเนอร์ที่ไม่มีสินค้าให้ดึง แจ้งทันทีพร้อมแนะนำให้สลับเป็นมุมมองผู้ซื้อ แทนการรอจนหมดเวลา'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'fixed',
        text: 'ราคาสินค้าที่ดึงจากมุมมองผู้ซื้อผิดทุกรายการ (บางตัวได้ราคาผ่อนต่อเดือน บางตัวเป็น ฿0.00) — ตอนนี้อ่านราคาจากบล็อกราคาจริงบนหน้าสินค้า ตรงกับที่เห็นใน Shopee'
      },
      {
        type: 'fixed',
        text: 'ชื่อสินค้าบางตัวมีเลข 0 ติดมาข้างหน้า (เช่น "0 CIVAGO...") ทำให้สินค้าตัวเดียวกันเข้าคลังซ้ำสองแถว'
      },
      {
        type: 'fixed',
        text: 'สินค้าเดิมเข้าคลังซ้ำเมื่อดึงใหม่ — ระบบจดจำสินค้าด้วยรหัสจริงจาก Shopee แล้ว ดึงซ้ำกี่ครั้งก็อัปเดตของเดิมแทนการเพิ่มแถวใหม่'
      },
      {
        type: 'fixed',
        text: 'ดึงสินค้าถูกใจแบบมุมมองพาร์ทเนอร์แล้วหลุดออกจากหน้ารายการกลางคัน ทำให้ดึงไม่ครบหรือค้าง'
      },
      {
        type: 'fixed',
        text: 'แบนเนอร์โปรโมชั่นถูกบันทึกเป็นสินค้าในคลัง'
      }
    ]
  },
  {
    version: '0.9.2',
    date: '2026-07-15',
    highlight: 'โพสต์ Shopee ออโต้เสถียรขึ้น ไม่ค้างรอจนหมดเวลา',
    changes: [
      {
        type: 'fixed',
        text: 'โหมดออโต้บางครั้งรอผลโพสต์ Shopee จนหมดเวลา 5 นาทีทั้งที่โพสต์สำเร็จแล้ว — เพิ่มช่องทางสำรองอ่านผลจากระบบอัตโนมัติโดยตรง รับผลได้แม้แอปถูกพักระหว่างโพสต์'
      },
      {
        type: 'fixed',
        text: 'ซิงก์สินค้าตอนเซสชันหมดอายุ ระบบจะต่ออายุการเข้าสู่ระบบให้อัตโนมัติและซิงก์ต่อทันที ไม่ล้มเงียบอีกต่อไป'
      }
    ]
  },
  {
    version: '0.9.1',
    date: '2026-07-15',
    highlight: 'แก้แนบรูปอ้างอิงวิดีโอไม่ติดสำหรับสินค้าที่ซิงก์จากคอมพิวเตอร์',
    changes: [
      {
        type: 'fixed',
        text: 'สินค้าที่ซิงก์มาจากแอปคอมพิวเตอร์เคยแนบรูปอ้างอิงตอนสร้างวิดีโอไม่ได้ (ขึ้น "ยังไม่มีรูป reference แนบในช่องวิดีโอ") — ตอนนี้ระบบเลือกใช้รูปจากคลาวด์ให้อัตโนมัติ'
      },
      {
        type: 'improved',
        text: 'เพิ่มตัวสำรอง: ถ้ารูปสินค้าในเครื่องหายหรืออ่านไม่ได้ ระบบจะดึงรูปต้นทางมาใช้แทนทั้งขั้นตอนรูปและวิดีโอ'
      },
      {
        type: 'improved',
        text: 'เลิกรายงานข้อผิดพลาดที่เกิดจากอินเทอร์เน็ตหลุดชั่วคราวเป็นปัญหาแอป ลดการแจ้งเตือนซ้ำซ้อน'
      }
    ]
  },
  {
    ...
    changes: [
      ...
      {
        type: 'improved',
        text: 'หยุดการทำงานอัตโนมัติพร้อมแจ้งสาเหตุทันที เมื่อพบปัญหาที่ต้องแก้ก่อน เช่น ยังไม่ได้เชื่อมต่อ Google Flow'
      },
      {
        type: 'fixed',
        text: 'กู้คืนหน้า Flow อัตโนมัติเมื่อหน้าเว็บภายในแอปมีปัญหา และแสดงสาเหตุความผิดพลาดชัดเจนขึ้น'
      }
    ]
  },
  {
