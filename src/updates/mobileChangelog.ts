...
export const MOBILE_CHANGELOG: MobileChangelogRelease[] = [
  ...
  },
  {
    ...
    changes: [
      {
        type: 'fixed',
        text: 'โพสต์ Shopee: บางกรณีระบบเลือกคลิปผิดตัวจากคลังไปโพสต์ (เช่น มีรูป/คลิปอื่นเข้าเครื่องแทรกระหว่างทำงาน) ตอนนี้เทียบความยาวคลิปที่เตรียมไว้กับไฟล์ในคลังก่อนเลือกเสมอ'
      },
      {
        type: 'fixed',
        text: 'ออโต้: แนบรูปสินค้าเป็น reference ไม่ได้เมื่อไฟล์รูปในเครื่องหาย ตอนนี้โหลดรูปจาก URL ต้นทางแทนและซ่อมไฟล์ในเครื่องให้อัตโนมัติ'
      },
      {
        type: 'improved',
        text: 'ดึงข้อเสนอ Shopee: แสดงความคืบหน้าระหว่างเลื่อนหาแท็บหมวดหมู่ที่อยู่นอกจอ (เดิมเงียบจนดูเหมือนค้าง) และรองรับชื่อหมวดที่ถูกตัดท้ายบนจอแคบ'
      }
    ]
  },
  {
    version: '0.5.1',
    date: '2026-07-11',
    highlight: 'ปรับปรุงภายในระบบโพสต์อัตโนมัติ',
    changes: [
      {
        type: 'improved',
        text: 'ออโต้: ตัดการส่งข้อมูลบันทึกการทำงานภายใน (debug log) ที่เกินจำเป็นระหว่างโพสต์อัตโนมัติออก หลังยืนยันจากการใช้งานจริงแล้วว่าการแก้ปัญหาโพสต์ Shopee ค้างในเวอร์ชันก่อนทำงานได้ตามปกติ'
      }
    ]
  },
  {
